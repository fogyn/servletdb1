...
@WebServlet("/views/getallavtobycolor")
public class ColorServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try(Connection connection = ConnectionUrl.createConnection();
            PreparedStatement statement = connection.prepareStatement("SELECT * from 'avto' WHERE color like ? ORDER BY year;");){

            String colorparam = req.getParameter("color").toLowerCase();
            statement.setString(1, colorparam);
            ...
            if(a==0){
                ...
                req.setAttribute("avto_notyear", "Авто такого цвета в базе нет");
            }
            else{
