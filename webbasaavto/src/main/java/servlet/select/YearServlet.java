...
@WebServlet("/views/getallavtobyyear")
public class YearServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try(Connection connection = ConnectionUrl.createConnection();
            PreparedStatement statement = connection.prepareStatement("SELECT * from 'avto' WHERE year = ? ORDER BY 'engine';");){

            int yearparam = Integer.parseInt(req.getParameter("year"));
            ...
            int a = 0;
                ...
                if(a==0){
                    ...
                    req.setAttribute("avto_notyear", "Авто такого года в базе нет");
                }
                else{
