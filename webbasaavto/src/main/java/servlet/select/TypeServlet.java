...
@WebServlet("/views/getallavtobytype")
public class TypeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try(Connection connection = ConnectionUrl.createConnection();
            PreparedStatement statement = connection.prepareStatement("SELECT * from 'avto' WHERE type like ? ORDER BY year;");){

            String typeparam = req.getParameter("type").toLowerCase();
            ...
            if(a==0){
                ...
                req.setAttribute("avto_notyear", "Авто такого типа кузова в базе нет");
            }
            else{
